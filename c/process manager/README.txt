...
7. exit: exit PMan with the option of terminating remaining children (y/n)
...
Other:
Left the provided readme unmodified (with the addition of exit command)

Provided unmodified "inf.c" file in the tar.gz submission
